...
/**
 * the weak demons have no brains and move whenever
 * they feel like it. they are so weak seriously
 * @author ross
 *
 */
public class WeakDemon extends Demon {
	...
	private String type = "weak"; //Easy,Med, or Hard
	...
	public WeakDemon(int x, int y) {
		super(x, y);
		this.setPos(new GameCoordinate(x,y,"Weak Demon"));
		LoadGame.createDemon("E", this);
		this.getImage("Down2");
	}
